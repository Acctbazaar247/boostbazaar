        ...
        >
            <div className="w-full max-w-[900px]">
                <div className="flex justify-between items-center">
                    ...
                    <Tooltip title="Reset">
                        <button
                            className="p-2 flex items-center gap-1 bg-primary rounded"
                            onClick={() => {
                                reset();
            ...
            <div className="md:w-[400px] md:mt-[60px] w-full md:min-w-[400px]">
                ...
                <div className="text-[13px]  dark:bg-slate-900 light:bg-slate-100 ">
                    <div className="pl-[30px] pt-4 pr-[20px]  pb-4 border-b border-slate-300">
                        ...
                        <p>
                            If the category you need isn&#39;t listed among the
                            main categories, select &quot;Others&quot; and
                            review the service menu below. The service
                            you&#39;re looking for will be listed under
                    ...
                    <div className="pl-[30px] pt-4 pr-[20px]  pb-4 border-b border-slate-300">
                        ...
                        <p>
                            When entering the link for the service to be
                            delivered to, ensure you include &quot;
                            <span className="text-primary">https://</span>
                            &quot; before typing the rest of the URL. For
                            example, if you&rsquo;re boosting Instagram
                            followers for your page, enter the link in this
                            format: &rsquo;
                            <span className="text-primary">
                                https://instagram.com/username
                            </span>
                            &rsquo;. This format may vary depending on the
                            service you&apos;re ordering, but the &rsquo;
                            <span className="text-primary">https://</span>
                            &rsquo; is essential to ensure you get the desired
                            results.
                        </p>
                    </div>
                    <div className="pl-[30px] pt-4 pr-[20px]  pb-4 ">
                        <h3 className="text-primary font-bold">
                            Checking Quantity Range
                        </h3>
                        <p>
                            Always verify the quantity range; each service has a
                            different minimum and maximum quantity. Ensure your
                            quantity falls within the specified range, which
                            you&apos;ll see written below the quantity menu when
