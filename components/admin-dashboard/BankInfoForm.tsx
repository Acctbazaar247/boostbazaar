  ...
  return (
    <div className="lg:w-[700px] py-4">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          disabled={addBankLoading || editBankLoading}
          className="bg-green-600 mt-4 text-white px-2 py-1 rounded-md flex items-center gap-2 disabled:opacity-55 transition-all"
        >
          {' '}
          {props.id ? 'Update Bank' : 'Add Bank'}
        </button>
      </form>
    </div>
  );
